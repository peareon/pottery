...
suncream4.addEventListener("mouseover", function(){
    suncreamDisplay.style.backgroundImage = 'url("./images/sucr/brown_side.jpg")'
})
...
suncream4.addEventListener("click", function(){
    suncreamDisplay.style.backgroundImage = 'url("./images/sucr/brown_side.jpg")'
})
